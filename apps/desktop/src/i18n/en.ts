...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc:
        'Unset LLIAM-GOV_DESKTOP_REMOTE_URL and LLIAM-GOV_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
  ...
  updates: {
    ...
    applyingBody: 'The Lliam-GOV updater will take over in its own window and reopen Lliam-GOV when it’s done.',
    applyingBodyBackend: 'The remote backend is applying the update and will restart. Lliam-GOV reconnects automatically when it’s back.',
    applyingClose: 'Lliam-GOV will close to apply the update.',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.lliam-gov/config.yaml). Lliam-GOV won’t ask again for commands like this — in this session or any future one.`,
