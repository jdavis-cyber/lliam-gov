...
export const en: Translations = {
  ...
  boot: {
    ready: 'LLIAM-GOV Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading LLIAM-GOV settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting LLIAM-GOV Desktop…'
    },
    errors: {
      backgroundExited: 'LLIAM-GOV background process exited.',
      backgroundExitedDuringStartup: 'LLIAM-GOV background process exited during startup.',
    ...
    failure: {
      title: "LLIAM-GOV couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your LLIAM-GOV backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update LLIAM-GOV',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting LLIAM-GOV Desktop.',
    ...
    native: {
      ...
      inputBody: 'LLIAM-GOV is waiting for your response.',
      turnDoneTitle: 'LLIAM-GOV finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to LLIAM-GOV defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while LLIAM-GOV is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'LLIAM-GOV asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while LLIAM-GOV was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let LLIAM-GOV follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what LLIAM-GOV is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen LLIAM-GOV, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'LLIAM-GOV checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading LLIAM-GOV configuration...',
    ...
    gateway: {
      ...
      intro:
        'LLIAM-GOV Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running LLIAM-GOV backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private LLIAM-GOV backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote LLIAM-GOV backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'LLIAM-GOV Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · LLIAM-GOV ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. LLIAM-GOV runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart LLIAM-GOV to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update LLIAM-GOV to generate pets.',
      backgroundHint: 'You can close this — LLIAM-GOV will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure LLIAM-GOV desktop' },
    ...
    hermesActiveSessions: (version, count) => `LLIAM-GOV ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent LLIAM-GOV environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. LLIAM-GOV will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'This removes the saved project from LLIAM-GOV. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting LLIAM-GOV...',
    placeholderReconnecting: 'Reconnecting to LLIAM-GOV…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give LLIAM-GOV a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'LLIAM-GOV will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask LLIAM-GOV to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating LLIAM-GOV…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting LLIAM-GOV…',
    ...
    unsupportedMessage: 'This version of LLIAM-GOV can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of LLIAM-GOV is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected LLIAM-GOV backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed LLIAM-GOV from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'LLIAM-GOV will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the LLIAM-GOV desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The LLIAM-GOV updater takes over in its own window and reopens LLIAM-GOV automatically when it’s done. Please don’t reopen LLIAM-GOV yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. LLIAM-GOV reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then LLIAM-GOV reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'LLIAM-GOV needs a one-time install',
    ...
    settingUpTitle: 'Setting up LLIAM-GOV',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another LLIAM-GOV CLI or desktop instance is running. Stop any running LLIAM-GOV instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The LLIAM-GOV installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with LLIAM-GOV",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'LLIAM-GOV is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting LLIAM-GOV…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run LLIAM-GOV',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point LLIAM-GOV at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — LLIAM-GOV connects automatically',
      loopback: 'Opens your browser to sign in — LLIAM-GOV connects automatically',
    ...
    authorizeThere: 'Authorize LLIAM-GOV there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize LLIAM-GOV there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `LLIAM-GOV Desktop v${version}`,
      ...
      gatewayTitle: 'LLIAM-GOV inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. LLIAM-GOV will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'LLIAM-GOV is restarting...',
      askRestart: 'Ask LLIAM-GOV to restart the server',
      lookingRestart: taskId => `LLIAM-GOV is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'LLIAM-GOV is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `LLIAM-GOV finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'LLIAM-GOV could not restart the server.',
      stillWorking:
        'LLIAM-GOV is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'LLIAM-GOV is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'LLIAM-GOV gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). LLIAM-GOV won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'LLIAM-GOV needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'LLIAM-GOV needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart LLIAM-GOV Desktop to use Save Image.',
    restartToSaveImages: 'Restart LLIAM-GOV Desktop to save images',
