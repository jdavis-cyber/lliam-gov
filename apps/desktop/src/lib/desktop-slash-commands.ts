...
/** Why a known LLIAM-GOV command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active LLIAM-GOV profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show LLIAM-GOV Agent version', surface: exec() },
 ...
 * LLIAM-GOV' built-in slash commands — i.e. skill commands (`/gif-search`,
