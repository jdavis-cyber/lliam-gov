...
// LLIAM-GOV' reasoning levels (VALID_REASONING_EFFORTS); `none` = thinking off.
// Empty config = LLIAM-GOV default (medium), shown as Medium.
        ...
        {needsSetup && !setupIsApiKey && (
          <p className="mt-2 text-xs text-muted-foreground">
            {selectedProviderRow?.auth_type === 'api_key'
              ...
              : `${selectedProviderRow?.name} signs in through your browser — LLIAM-GOV runs the flow for you.`}
          </p>
        )}
