 ...
 *
 * A public install can end up with `origin=git@github.com:jdavis-cyber/lliam-gov.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/jdavis-cyber/lliam-gov.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/jdavis-cyber/lliam-gov'
