    ...
    for config_path in configs:
        try:
            ...
            for line in content.split('\n'):
                # Skip legacy and current PATH comments and their following line.
                if '# Hermes Agent' in line or '# Lliam-GOV' in line or '# hermes-agent' in line:
                    skip_next = True
                    continue
...
def run_uninstall(args):
    ...
    print(color("│               ⚕ Lliam-GOV Uninstaller                 │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()
    ...
    print()
    print("Thank you for using Lliam-GOV! ⚕")
    print()
