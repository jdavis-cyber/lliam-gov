...
OFFICIAL_REPO_URLS = {
    "https://github.com/jdavis-cyber/lliam-gov.git",
    "git@github.com:jdavis-cyber/lliam-gov.git",
    "https://github.com/NousResearch/hermes-agent",
    "git@github.com:NousResearch/hermes-agent",
}
OFFICIAL_REPO_URL = "https://github.com/jdavis-cyber/lliam-gov.git"
    ...
    if not has_upstream:
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/jdavis-cyber/lliam-gov.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/jdavis-cyber/lliam-gov.git' to add later."
            )
