...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Lliam-GOV"             # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Lliam-GOV"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Lliam-GOV",
            "welcome": "Welcome to Lliam-GOV! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
