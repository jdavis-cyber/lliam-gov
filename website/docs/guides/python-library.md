...
```bash
pip install git+https://github.com/jdavis-cyber/lliam-gov.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/jdavis-cyber/lliam-gov.git
```

You can also pin it in your `requirements.txt`:

```text
hermes-agent @ git+https://github.com/jdavis-cyber/lliam-gov.git
```
